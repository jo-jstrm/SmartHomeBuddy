...
function deserialize_SmartHomeBuddy_Devices(buffer_arg) {
  return devices_database_pb.Devices.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_SmartHomeBuddy_DevicesRequest(buffer_arg) {
  return devices_database_pb.DevicesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
