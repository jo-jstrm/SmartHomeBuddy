...
interface IPcapDatabaseService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  loadPcapIntoDatabase: grpc.MethodDefinition<
    pcap_database_pb.DbLoadRequest,
    pcap_database_pb.DbLoadResponse
  >;
}
...
export interface IPcapDatabaseServer extends grpc.UntypedServiceImplementation {
  loadPcapIntoDatabase: grpc.handleUnaryCall<
    pcap_database_pb.DbLoadRequest,
    pcap_database_pb.DbLoadResponse
  >;
}
...
export class PcapDatabaseClient extends grpc.Client {
  ...
  loadPcapIntoDatabase(
    argument: pcap_database_pb.DbLoadRequest,
    callback: grpc.requestCallback<pcap_database_pb.DbLoadResponse>
