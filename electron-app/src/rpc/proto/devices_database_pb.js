...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.SmartHomeBuddy.DevicesRequest.displayName = 'proto.SmartHomeBuddy.DevicesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.SmartHomeBuddy.Devices = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SmartHomeBuddy.Devices.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.SmartHomeBuddy.DevicesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.SmartHomeBuddy.DevicesRequest.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SmartHomeBuddy.DevicesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    param: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
...
proto.SmartHomeBuddy.DevicesRequest.deserializeBinary = function(bytes) {
  ...
  return proto.SmartHomeBuddy.DevicesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.SmartHomeBuddy.DevicesRequest}
 */
proto.SmartHomeBuddy.DevicesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SmartHomeBuddy.DevicesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getParam();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!Object}
 */
proto.SmartHomeBuddy.Device.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.SmartHomeBuddy.Device}
 */
proto.SmartHomeBuddy.Device.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SmartHomeBuddy.Device.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!Object}
 */
proto.SmartHomeBuddy.Devices.prototype.toObject = function(opt_includeInstance) {
...
proto.SmartHomeBuddy.Devices.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.SmartHomeBuddy.Device.toObject, includeInstance)
  };
 ...
 * @return {!proto.SmartHomeBuddy.Devices}
 */
proto.SmartHomeBuddy.Devices.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      reader.readMessage(value,proto.SmartHomeBuddy.Device.deserializeBinaryFromReader);
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.SmartHomeBuddy.Devices.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!proto.SmartHomeBuddy.Device}
 */
proto.SmartHomeBuddy.Devices.prototype.addDevices = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.SmartHomeBuddy.Device, opt_index);
};
