...
from shbdeviceidentifier.rpc.proto import (
    devices_database_pb2 as shbdeviceidentifier_dot_rpc_dot_proto_dot_devices__database__pb2,
)
...
def add_DevicesDatabaseServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("SmartHomeBuddy.DevicesDatabase", rpc_method_handlers)
